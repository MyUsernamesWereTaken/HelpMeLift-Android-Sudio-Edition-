...
import com.example.helpmelift.databinding.ActivityCalvesMusclesBinding;

public class CalvesMuscle extends AppCompatActivity {

    private ActivityCalvesMusclesBinding binding;
    private String muscleSelected;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_calves_muscles);
